          ...
          {reversedNewsOrder.map((newsItem: NewData, index: number) =>
            <div className="flex flex-col py-4 h-full max-w-[900px]" key={index}>
              <div className="w-full h-4/5 overflow-hidden">
                <img src={newsItem.img? `data:image/png;base64,${newsItem.img}`:"/news_handball_player.jpg"} className="m-auto w-full object-contain" alt={`Image for the article ${newsItem.title}`} />
              </div>
